    ...
    const linkSections = [
        {
            ...
            links: [
                ...
                { text: "Doctor Consultation", path: '/', icon: null },
                { text: "Baki dekhte hai", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
            links: [
                ...
                { text: "Become a Distributor", path: '/create-store', icon: null },
            ]
        },
        {
            title: "CONTACT",
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        {/* <Link href="/"className="flex items-center text-4xl font-semibold text-slate-700 leading-none">
                            <Image
                                src={assets.Klogo}
                                alt="K-Sarwar Logo"
                                width={31}
                                height={36}
                                className="mr-1 block object-contain"
                            />
                        ...
                        <Link href="/" className="flex items-center font-semibold text-slate-700 leading-none">
                            <Image
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to K-SARWAR, a trusted homeopathic research laboratory dedicated to developing safe, effective, and natural medicines. We combine scientific research with traditional homeopathy to support holistic healing and well-being.</p>
