...
//                         <span className="text-green-600">K-</span>SARWAR<span className="text-green-600 text-5xl leading-0">.</span>
...
import { PackageIcon, Search, ShoppingCart, Home, Info, Phone, CreditCard } from "lucide-react";
import Link from "next/link";
import { useRouter } from "next/navigation";
import { useState } from "react";
import { useSelector } from "react-redux";
...
const Navbar = () => {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.push(`/shop?search=${search}`);
        setShowMobileSearch(false); // mobile search auto close
    };
